...
var project = function (path, name, isouter) {
    ...
    this._services = [];
    this._filters = [];
    this._packet = axes.packet(this._path + "node_modules", this._path + "WEBINF/src/");
    this.config = null;
    this._scope = {};
    this._session = {};
};
project.prototype.run = function (code, fn) {
    ...
    this.sessionWatcher();
    axes.file(this._path + "WEBINF/web.json").read().done(function (data) {
        try {
...
project.prototype.packetInit = function (fn) {
    var ths = this;
    axes.file(this._path + "WEBINF/src/").getAllSubFilesPathWithSuffix("js").done(function (t) {
        var n = "";
        if (t.length > 0) {
            var que = axes.queue(), n = "";
