...
corgi.prototype.createProject = function (name, path, remotePath, localFolder) {
...
module.exports = {
    ...
    create: function (name, path, remotePath,installPath) {
        corgiserver.createProject(name, path, remotePath,installPath);
    },
    stop: function () {},
    restart: function () {},
    scan: function () {
